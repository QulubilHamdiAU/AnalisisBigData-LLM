...
palm.configure(api_key="AIzaSyBsWS0dtZy4lIHjkZ0x-zE9JyeMYG-PBc4")
...
context = "AIFAQ: Provide information for you about student admission."

st.set_page_config(page_title="AIFAQ")
...
st.title("AIFAQ")
st.sidebar.markdown("# AIFAQ Chatbot")
...
if prompt := st.chat_input():
    full_prompt = f'Provide instructions or ask questions about student admission is {prompt}'

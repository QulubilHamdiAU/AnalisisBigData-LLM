...
st.sidebar.markdown("This is a AIFAQ chatbot designed to provide information about student admission. "
                    "Feel free to ask questions, and the chatbot will respond accordingly.")

st.title("Chatbot")
st.markdown("Welcome to AIFAQ! This chatbot is designed to provide information about student admission. ")
